...
Officer: 5714476
CaseNum: 402-3-85568333-5714476
...
function draw()
{
	...
	if (det.locationX = 259)
	{
		det.speedX = 0;
		det.speedY = 1;
	}

	if (det.locationY = 512)
	{
		det.speedX = 1;
		det.speedY = 0;
	}

	if (det.locationX = 516)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	...
	if (det.locationX = 637)
	{
		det.speedX = 0;
		det.speedY = 1;
	}

	if (det.locationY = 571)
	{
		det.speedX = 1;
		det.speedY = 0;
	}

	if (det.locationX = 764)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
	...
	if (det.locationX = 892)
	{
		det.speedX = 0;
		det.speedY = 1;
	}

	if (det.locationY = 701)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
